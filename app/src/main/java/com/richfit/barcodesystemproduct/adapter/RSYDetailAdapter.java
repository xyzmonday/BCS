...
import com.richfit.barcodesystemproduct.adapter.itemdelegate.RSYChildHeaderItemDelegate;
...
public class RSYDetailAdapter  extends MultiItemTypeTreeAdapter<RefDetailEntity> {


    public RSYDetailAdapter(Context context, List<RefDetailEntity> allNodes, List<RowConfig> parentNodeConfigs, List<RowConfig> childNodeConfigs, String companyCode) {
        ...
        addItemViewDelegate(Global.CHILD_NODE_HEADER_TYPE,new RSYChildHeaderItemDelegate());
