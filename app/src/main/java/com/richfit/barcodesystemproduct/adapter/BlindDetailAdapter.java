...
public class BlindDetailAdapter extends CommonTreeAdapter<InventoryEntity> {
    ...
    public BlindDetailAdapter(Context context, int layoutId, List<InventoryEntity> allNodes, List<RowConfig> parentNodeConfigs, List<RowConfig> childNodeConfigs, String companyCode) {
