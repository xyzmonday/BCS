package com.richfit.barcodesystemproduct.module_returngoods.imp;
...
public class QingHaiRGDetailPresenterImp extends DSDetailPresenterImp{

    @Inject
    public QingHaiRGDetailPresenterImp(@ContextLife("Activity") Context context) {
        super(context);
    }
