package com.richfit.barcodesystemproduct.module_movestore.baseheader.imp;
...
import com.richfit.barcodesystemproduct.module_movestore.baseheader.IMSHeaderPresenter;
import com.richfit.barcodesystemproduct.module_movestore.baseheader.IMSHeaderView;
...
public class MSHeaderPresenterImp extends BasePresenter<IMSHeaderView>
        implements IMSHeaderPresenter {

    IMSHeaderView mView;

    @Inject
    public MSHeaderPresenterImp(@ContextLife("Activity") Context context) {
        super(context);
    }
