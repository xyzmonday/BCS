package com.richfit.barcodesystemproduct.module_movestore.qinghai_ubsto351.imp;

import android.content.Context;
import android.text.TextUtils;

import com.richfit.barcodesystemproduct.di.ContextLife;
import com.richfit.barcodesystemproduct.module_movestore.basedetail.imp.BaseMSDetailPresenter;
...
public class QingHaiUnSto351DetailPresenterImp extends BaseMSDetailPresenter {

    @Inject
    public QingHaiUnSto351DetailPresenterImp(@ContextLife("Activity") Context context) {
        super(context);
    }
