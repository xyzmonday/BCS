package com.richfit.barcodesystemproduct.module_delivery.qinghai_dsxs.imp;
...
public class QingHaiDSXSDetailPresenterImp extends DSDetailPresenterImp {


    @Inject
    public QingHaiDSXSDetailPresenterImp(@ContextLife("Activity") Context context) {
        super(context);
    }
