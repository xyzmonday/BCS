package com.richfit.barcodesystemproduct.module_delivery.qinghai_dsn.edit.imp;

import android.content.Context;

import com.richfit.barcodesystemproduct.base.BasePresenter;
import com.richfit.barcodesystemproduct.di.ContextLife;
import com.richfit.barcodesystemproduct.module_delivery.qinghai_dsn.edit.IQingHaiDSNEditPresenter;
...
public class QingHaiDSNEditPresenterImp extends BasePresenter<IQingHaiDSNEditView>
        implements IQingHaiDSNEditPresenter {

    IQingHaiDSNEditView mView;

    @Inject
    public QingHaiDSNEditPresenterImp(@ContextLife("Activity") Context context) {
        super(context);
    }
    ...
    public void getInventoryInfo(String queryType, String workId, String invId, String workCode,
        ...
        RxSubscriber<List<InventoryEntity>> subscriber =
                mRepository.getInventoryInfo(queryType, workId, invId, workCode, invCode, storageNum,
                        materialNum, materialId, "", "", batchFlag, location, specialInvFlag, specialInvNum, invType)
                        .compose(TransformerHelper.io2main())
