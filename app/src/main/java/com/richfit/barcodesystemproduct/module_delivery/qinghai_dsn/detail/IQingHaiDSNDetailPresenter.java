...
public interface IQingHaiDSNDetailPresenter extends IPresenter<IQingHaiDSNDetailView>{
    ...
    void editNode(ArrayList<String> sendLocations, ArrayList<String> recLocations,
                  RefDetailEntity node, Class modifyClass, String companyCode, String bizType,
