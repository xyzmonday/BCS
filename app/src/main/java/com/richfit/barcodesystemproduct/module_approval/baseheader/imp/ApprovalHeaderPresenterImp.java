package com.richfit.barcodesystemproduct.module_approval.baseheader.imp;
...
import com.richfit.barcodesystemproduct.module_approval.baseheader.IApprovalHeaderPresenter;
import com.richfit.barcodesystemproduct.module_approval.baseheader.IApprovalHeaderView;
...
public class ApprovalHeaderPresenterImp extends BasePresenter<IApprovalHeaderView>
        implements IApprovalHeaderPresenter {

    IApprovalHeaderView mView;

    @Inject
    public ApprovalHeaderPresenterImp(@ContextLife("Activity") Context context) {
        super(context);
    }
