package com.richfit.barcodesystemproduct.module_approval.qingyang_ao.collect.imp;
...
public class ApprovalOtherPresenterImp extends BasePresenter<IApprovalOtherView>
        implements IApprovalOtherPresenter {

    IApprovalOtherView mView;

    @Inject
    public ApprovalOtherPresenterImp(@ContextLife("Activity") Context context) {
        super(context);
    }
