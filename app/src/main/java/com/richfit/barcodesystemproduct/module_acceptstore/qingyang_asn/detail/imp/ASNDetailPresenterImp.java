package com.richfit.barcodesystemproduct.module_acceptstore.qingyang_asn.detail.imp;
...
public class ASNDetailPresenterImp extends BasePresenter<IASNDetailView>
        implements IASNDetailPresenter {

    IASNDetailView mView;

    @Inject
    public ASNDetailPresenterImp(@ContextLife("Activity") Context context) {
        super(context);
    }
