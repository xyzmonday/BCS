...
public interface IASDetailPresenter extends IPresenter<IASDetailView> {
     ...
     */
    void submitData2BarcodeSystem(String transId, String bizType, String refType, int inspectionType, String voucherDate);
