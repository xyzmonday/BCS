...
import com.richfit.common_lib.iosdialog_lib.interfaces.Assignable;
...
public class DialogAssigner implements Assignable {
    ...
    @Override
    public ConfigBean assignMdSingleChoose(Context context, CharSequence title, int defaultChosen, CharSequence[] words, MyItemDialogListener listener) {
        ConfigBean bean = new ConfigBean();
        bean.context = context;
        bean.title = title;
    ...
    @Override
    public ConfigBean assignMdMultiChoose(Context context, CharSequence title, CharSequence[] words, boolean[] checkedItems, MyDialogListener btnListener) {
        ConfigBean bean = new ConfigBean();
        bean.context = context;
        bean.msg = title;
        bean.title = title;
    ...
    @Override
    public ConfigBean assignCustomBottomSheet(Context context, View contentView) {
        ConfigBean bean = new ConfigBean();
        bean.context = context;
        bean.customView = contentView;
