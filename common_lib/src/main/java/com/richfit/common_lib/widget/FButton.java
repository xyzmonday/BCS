...
public class FButton extends Button implements View.OnTouchListener {
    ...
    private void init() {
        ...
        mButtonColor = resources.getColor(R.color.blue_400);
        mShadowColor = resources.getColor(R.color.blue_a700);
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < typedArray.getIndexCount(); i++) {
            ...
            if (attr == R.styleable.FButton_shadowEnabled) {
                ...
                mButtonColor = typedArray.getColor(attr, ContextCompat.getColor(context,R.color.blue_400));
            } else if (attr == R.styleable.FButton_shadowColor) {
                mShadowColor = typedArray.getColor(attr, ContextCompat.getColor(context, R.color.blue_a700));
                isShadowColorDefined = true;
            } else if (attr == R.styleable.FButton_shadowHeight) {
                mShadowHeight = typedArray.getDimensionPixelSize(attr, (int) context.getResources().getDimension(R.dimen.fbutton_default_shadow_height));
            } else if (attr == R.styleable.FButton_cornerRadius) {
                mCornerRadius = typedArray.getDimensionPixelSize(attr, (int) context.getResources().getDimension(R.dimen.fbutton_default_conner_radius));
            }
        }
        typedArray.recycle();
