...
import com.richfit.common_lib.flyrefresh.internal.MountanScenceView;
...
public class FlyRefreshLayout extends PullHeaderLayout {
    ...
    protected void onFinishInflate() {
        ...
        if (getIconView() == null) {
            setActionDrawable(AppCompat.getDrawable(getContext(),R.mipmap.icon_send));
        }
    }
    ...
    public void onRefreshFinish() {
        ...
        final int offDistY = -UiUtil.dpToPx(10);
